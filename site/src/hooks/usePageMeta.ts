...
const DEFAULT_TITLE = "宝拓墨间 · 从一句灵感到一整本小说";
const DEFAULT_DESCRIPTION =
  "宝拓墨间是面向长篇小说的 AI Native 开源生产系统：自动导演、世界观、角色、拆章、章节执行和质量修复串成一条可暂停可恢复的长篇生产链，帮助新手把想法推进到完整成书。";
const CANONICAL_BASE = "https://batuo88.github.io/baotuo-mojian/";
...
export function resolvePageMeta(meta: PageMeta | null | undefined): ResolvedPageMeta {
  const title = meta?.title ? `${meta.title} · 宝拓墨间` : DEFAULT_TITLE;
