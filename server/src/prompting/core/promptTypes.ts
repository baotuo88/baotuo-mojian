...
export interface PromptContextGroupCount {
  group: string;
  count: number;
  estimatedTokens: number;
}
...
export interface PromptInvocationMeta {
  ...
  droppedContextBlockCount: number;
  summarizedContextBlockCount: number;
  selectedContextGroupCounts: PromptContextGroupCount[];
