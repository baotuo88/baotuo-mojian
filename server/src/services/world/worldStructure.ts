...
import { makeId, formatRuleText, WORLD_STRUCTURE_SCHEMA_VERSION, type WorldStructureSource } from "./worldStructureBase";

export {
  buildWorldBindingSupport,
  applyStructuredWorldToLegacyFields,
  buildWorldStructureOverview,
} from "./worldStructureSerialize";

export { WORLD_STRUCTURE_SCHEMA_VERSION, type WorldStructureSource };
