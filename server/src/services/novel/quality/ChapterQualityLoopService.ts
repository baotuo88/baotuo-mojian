...
export function buildChapterQualityLoopChapterUpdate(
  ...
  const nextRepairHistory = appendRepairHistory(chapter.repairHistory, assessment, terminalAction, source);
  ...
  return {
    ...
    ...(score ? {
      ...
      continuityScore: score.coherence,
      characterScore: score.voice,
      pacingScore: score.pacing,
    } : {}),
