...
export function useChapterExecutionActions({
  ...
  const expandChapter = () => {
    ...
    onStartRepair([buildChapterRepairIssue("expand")]);
    onMessage("已提交扩写任务。");
  };
  ...
  const compressChapter = () => {
    ...
    onStartRepair([buildChapterRepairIssue("compress")]);
    onMessage("已提交压缩任务。");
  };
  ...
  const strengthenConflict = () => {
    ...
    onStartRepair([buildChapterRepairIssue("strengthenConflict")]);
    onMessage("已触发冲突强化。");
  };
  ...
  const enhanceEmotion = () => {
    ...
    onStartRepair([buildChapterRepairIssue("enhanceEmotion")]);
    onMessage("已触发情绪增强。");
  };
  ...
  const unifyStyle = () => {
    ...
    onStartRepair([buildChapterRepairIssue("unifyStyle")]);
    onMessage("已触发文风统一。");
  };
  ...
  const addDialogue = () => {
    ...
    onStartRepair([buildChapterRepairIssue("addDialogue")]);
    onMessage("已触发对话增强。");
  };
  ...
  const addDescription = () => {
    ...
    onStartRepair([buildChapterRepairIssue("addDescription")]);
    onMessage("已触发描写增强。");
  };
