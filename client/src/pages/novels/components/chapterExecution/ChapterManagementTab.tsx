...
import { buildReplanRecommendationFromAuditReports } from "../../chapterPlanning.shared.ts";
import type { ChapterTabViewProps } from "../workspace/NovelEditView.types.ts";
import WorldInjectionHint from "../novelWorld/WorldInjectionHint";
import ChapterExecutionActionPanel from "./ChapterExecutionActionPanel";
import ChapterExecutionInsightsSidebar from "../chapterInsights/index";
...
import {
  ...
  type AssetTabKey,
  type QueueFilterKey,
} from "./chapterExecution.shared.tsx";
import DirectorTakeoverEntryPanel from "../autoDirector/DirectorTakeoverEntryPanel";
