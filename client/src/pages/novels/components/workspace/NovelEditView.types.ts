...
import type { ChapterExecutionBackgroundActivity } from "../chapterExecution/chapterExecution.shared.tsx";
import type { QuickCharacterCreatePayload } from "../characterPanel/characterPanel.utils.ts";
import type { ChapterReviewResult } from "../../chapterPlanning.shared.ts";
import type { ChapterDetailBundleRequest } from "../../chapterDetailPlanning.shared.ts";
import type { StructuredSyncOptions } from "../../novelEdit.utils.ts";
import type { NovelBasicFormState } from "../../novelBasicInfo.shared.ts";
import type { ExistingOutlineChapter } from "../../volumePlan.utils.ts";
