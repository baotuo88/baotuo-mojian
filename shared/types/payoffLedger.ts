...
export type PayoffLedgerIdentityAction = "reuse" | "create";

export interface PayoffLedgerIdentityDecision {
  action: PayoffLedgerIdentityAction;
  existingLedgerKey?: string | null;
  reason: string;
